const ru_RU = {
    ...
    "message.airborne_skyes.hammer": "Позволяют мастерить!",
    "block.airborne_skies.engineer_hammer": "Инженерный молот",
...
const en_US = {
    ...
    "message.airborne_skyes.hammer": "Can to create!",
    "block.airborne_skies.engineer_hammer": "Engineer Hammer",
